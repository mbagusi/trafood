...
<head>
    ...
    <title>Data Food Jawa Barat</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-hover text-light" style="background-color: #28251f">
                        ...
                        <tbody>
                          @forelse ($foods as $food_jabar)
                          <tr>
                            <th>{{$loop->iteration}}</th>
                            <td align="center">{{$food_jabar->nama}}</td>
                            <td align="center">{{$food_jabar->jenis}}</td>
                            <td align="center">{{$food_jabar->harga}}</td>
                            <td align="center"><img height="50px" src="{{url('')}}/{{$food_jabar->image}}" class="rounded" alt=""></td>
                            <td align="center"><a href="{{ route('admin.editJabar',['id' => $food_jabar->id]) }}" style="color: white">
                                <button type="submit" class="btn btn-success ml-3">Edit
                                <form action="{{ route('admin.destroyJabar',['id'=>$food_jabar->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
