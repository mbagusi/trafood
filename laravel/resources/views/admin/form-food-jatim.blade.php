            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin/<b>Food Jawa Timur</b></h1>
                    </div>

                    <h5>Daftar Food Jawa Timur</h5>
                    ...
                    <a class="btn btn-bover text-light" href="{{ url('/create-food-jatim') }}" role="button" style="float: right; background-color: #28251f; margin-bottom: 5px"><i class="bi bi-plus"></i>Tambah Data</a>
