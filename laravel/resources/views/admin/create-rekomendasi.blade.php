...
<head>
    ...
    <title>Create Food Rekomendasi</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin/Food Rekomendasi/<b>Tambah Data</b></h1>
                    </div>

                    <h5>Tambah Data Food Rekomendasi</h5>

                    <form action="{{ route('admin.storeRekomendasi') }}" method="POST" enctype="multipart/form-data">
                        @csrf
