...
<link href=" {{ url('') }}/your-path-to-fontawesome/css/all.css" rel="stylesheet">
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a class="logo me-auto me-lg-0" href="index.html" style="text-decoration: none; color: white;">Trafoo.id</a>

      <nav id="navbar" class="navbar order-last order-lg-0" style="margin: auto;">
        <ul>
          <li><a class="nav-link scrollto" href="{{ url('/') }}">Beranda</a></li>
          <li><a class="nav-link scrollto" href="kategori.html">Kategori</a></li>
                ...
                <div class="col">       
                    <div class="card" {{$loop->iteration}}>
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fw-bold">Rp. {{$food_banten->harga}}</p>
