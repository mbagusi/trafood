...
<link href="{{ url('') }}/your-path-to-fontawesome/css/all.css" rel="stylesheet">
    ...
    <title>Trafoo.id - Jawa Timur</title>
  </head>
  <body>
    ...
    <section id="list">
        <div class="container" data-aos="fade-up">
            <div class="row text-center" >
                <h1 style="margin-top: 130px; font-family: 'Poppins', sans-serif;">Makanan khas <br>Jawa Timur</h1>
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col">
                    <div class="card" {{$loop->iteration}} >
                        <img src="{{url('')}}/{{$food_jatim->image}}" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title fw-bold">{{$food_jatim->nama}}</h5>
                            <p class="card-text fw-bold">Rp. {{$food_jatim->harga}}</p>
